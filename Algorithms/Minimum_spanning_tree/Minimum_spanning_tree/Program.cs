        ...
        { /* /*
          ...
          //                          2 4 3");
            ...
            */
            ...
            list.Add(new Edge_Boruvka(0, 1, 3));
            list.Add(new Edge_Boruvka(1, 2, 1));
            list.Add(new Edge_Boruvka(1, 3, 5));
            list.Add(new Edge_Boruvka(2, 3, 6));
            list.Add(new Edge_Boruvka(2, 4, 5));
            list.Add(new Edge_Boruvka(3, 4, 4));
            list.Add(new Edge_Boruvka(4, 0, 1));
